      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
          ...
          <div className="bg-gradient-to-r from-blue-700 to-indigo-700 text-white px-4 py-6 lg:p-8">
            ...
            <p className="text-blue-100 text-sm lg:text-lg">
              ...
              monthly payments,
              loan balances,
              and total mortgage interest costs.
            </p>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 lg:p-8 mt-6">
          ...
          <p className="text-slate-700 leading-8 text-lg">
            ...
            results in an estimated monthly payment of
            <strong> ${monthlyPayment.toFixed(2)}</strong>.
            Total interest paid over the loan term is approximately
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 lg:p-8 mt-6">
          ...
          <p className="text-slate-700 leading-8 text-lg">
            ...
            over 30 years
            results in monthly payments of approximately
            <strong> ${monthlyPayment.toFixed(2)}</strong>.
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 lg:p-8 mt-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-slate-700 leading-8">
                Making extra payments or shortening
                the loan term can reduce total interest costs.
              </p>
