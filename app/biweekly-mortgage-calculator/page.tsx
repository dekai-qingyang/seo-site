      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
          ...
          <div className="bg-gradient-to-r from-blue-700 to-cyan-700 text-white px-4 py-6 lg:p-8">
            ...
            <p className="text-blue-100 text-sm lg:text-lg">
              Estimate biweekly mortgage payments,
              interest savings,
              and faster mortgage payoff schedules.
            </p>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 lg:p-8 mt-6">
          ...
          <h2 className="text-3xl font-black mb-5">
            Biweekly Mortgage Explanation
          </h2>

          <p className="text-slate-700 leading-8 text-lg">

            A biweekly mortgage payment plan allows homeowners
            to make half-payments every two weeks,
            resulting in 26 half-payments annually.
            This strategy may reduce total interest costs
            and shorten the mortgage payoff timeline.
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <h3 className="font-bold text-xl mb-2">
                Does biweekly payment save money?
              </h3>

              <p className="text-slate-700 leading-8">
                Yes.
                Biweekly mortgage payments may reduce
                total interest and shorten payoff time.
              </p>
            ...
            <div>
              ...
              <h3 className="font-bold text-xl mb-2">
                Why are there 26 payments annually?
              </h3>

              <p className="text-slate-700 leading-8">
                Biweekly payments occur every two weeks,
                resulting in 26 half-payments per year.
              </p>
