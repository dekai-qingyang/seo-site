    ...
    <main className="min-h-screen bg-slate-100 py-4 lg:py-10 px-2 lg:px-4">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
          ...
          <div className="bg-gradient-to-r from-rose-700 to-red-700 text-white px-4 py-6 lg:p-8">
            ...
            <p className="text-rose-100 text-sm lg:text-lg">
              Calculate debt avalanche repayment plans,
              interest savings,
              and high-interest debt payoff strategies.
            </p>
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="bg-gradient-to-b from-rose-50 to-white p-4 lg:p-8">
              ...
              <div className="bg-gradient-to-r from-rose-700 to-red-700 text-white rounded-3xl p-5 lg:p-8 mb-6">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 lg:p-8 mt-6">
          ...
          <p className="text-slate-700 leading-8 text-lg">
            ...
            The debt avalanche strategy focuses on paying off
            high-interest debt first to minimize total interest costs.
            With
            <strong> ${totalDebt.toLocaleString()}</strong>
            in debt and monthly payments of
            <strong> ${monthlyPayment}</strong>,
            debt payoff may take approximately
            <strong> {months} months</strong>
            while paying approximately
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 lg:p-8 mt-6">
          ...
          <p className="text-slate-700 leading-8 text-lg">
            ...
            A borrower with
            $30,000 in high-interest debt
            paying
            $1,200 monthly
            could potentially pay off debt in approximately
            <strong> {months} months</strong>
            while minimizing total interest costs.
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 lg:p-8 mt-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-slate-700 leading-8">
                Yes. Paying high-interest debt first
                typically minimizes total interest paid over time.
              </p>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 lg:p-8 mt-6 mb-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a
              ...
              className="bg-slate-100 hover:bg-rose-50 rounded-2xl p-5 font-bold"
            >
