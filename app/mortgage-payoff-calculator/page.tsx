      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
          ...
          <div className="bg-gradient-to-r from-blue-700 to-cyan-700 text-white px-4 py-6 lg:p-8">
            ...
            <p className="text-blue-100 text-sm lg:text-lg">
              Estimate mortgage payoff timelines,
              interest savings,
              ...
              <div className="bg-white rounded-3xl border border-slate-200 overflow-hidden">
                ...
                <div className="divide-y divide-slate-200">
                  ...
                  <SummaryRow
                    ...
                    value={`$${totalInterestPaid.toFixed(0)}`}
                  />
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 lg:p-8 mt-6">
          ...
          <h2 className="text-3xl font-black mb-5">
            Mortgage Payoff Explanation
          </h2>

          <p className="text-slate-700 leading-8 text-lg">

            A mortgage payoff calculator estimates how quickly
            a homeowner can repay a mortgage loan by making
            additional monthly payments.
            Extra payments may significantly reduce
            total interest costs and shorten loan duration.
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 lg:p-8 mt-6">
          ...
          <div className="bg-slate-100 rounded-2xl p-5 overflow-x-auto">
            ...
            <p className="text-lg font-mono">
              Balance = Loan − Principal Payments
            </p>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 lg:p-8 mt-6">
          ...
          <p className="text-slate-700 leading-8 text-lg">
            ...
            and save thousands in interest costs.
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-slate-700 leading-8">
                Yes.
                Extra mortgage payments reduce principal faster,
            ...
            <div>
              ...
              <p className="text-slate-700 leading-8">
                Most mortgage loans allow early repayment,
                though some lenders may charge prepayment fees.
              </p>
