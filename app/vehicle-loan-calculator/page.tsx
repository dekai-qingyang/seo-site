...
<div className="mt-12 bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <a
      ...
      className="border border-slate-200 rounded-2xl p-4 hover:border-blue-500 hover:shadow-md transition"
    >
    ...
    >
      ...
      <p className="text-sm text-slate-500 mt-1">
        Calculate total loan repayment costs.
      </p>
    </a>
    ...
    >
      ...
      <p className="text-sm text-slate-500 mt-1">
        Track your future savings balance.
      </p>
    </a>
    ...
    >
      ...
      <p className="text-sm text-slate-500 mt-1">
        Estimate monthly vehicle payments.
      </p>
    </a>
